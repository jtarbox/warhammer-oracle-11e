...
const CHAOS_SPACE_MARINES_STRATAGEMS: Stratagem[] = [
  ...
  },
  {
    ...
    target: "One HERETIC ASTARTES Infantry or Mounted unit (excluding DAMNED) from your army within 8\" of that enemy unit and not within Engagement Range of any enemy units.",
    effect: "Your unit can make a Normal move of up to 6\".",
    gameModes: ["40k"],
  },
  {
  ...
  },
  {
    ...
    phase: "Opponent's Movement phase",
    when: "Your opponent's Movement phase, just after an enemy unit ends a move.",
    target: "One HERETIC ASTARTES Infantry or Mounted unit from your army within 8\" of that enemy unit and not within Engagement Range of any enemy units.",
    effect: "Your unit can make a Normal move of up to 6\".",
    gameModes: ["40k"],
  },
  {
  ...
  },
  {
    ...
    effect: "Set your unit up anywhere on the battlefield that is more than 6\" horizontally away from all enemy units, but until the end of the turn, it is not eligible to declare a charge. Select one enemy Infantry or Mounted unit within 9\" of and visible to your unit: that unit makes a battle-shock roll, with -1 to the result.",
    gameModes: ["40k"],
  },
  {
